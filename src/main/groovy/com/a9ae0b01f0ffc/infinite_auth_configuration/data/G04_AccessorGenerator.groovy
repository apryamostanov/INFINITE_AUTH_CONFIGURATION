...
class G04_AccessorGenerator {
    ...
    void generate_data(I_accessor_repository p_accessor_repository, I_endpoint_repository p_endpoint_repository, I_version_repository p_version_repository) {
        ...
        l_entity_set.add(new Accessor(lookupPriority: 0, platform: "Any", appVersion: "Any", user: "Any", FIID: "Any", product: "Any", productGroup: "Single Currency", accessorName: "Any accessor Single Currency 0.0.x", appName: "Any", endpoint: GC_ANY_ENDPOINT, apiVersion: p_version_repository.findByVersionName("0.0.x").first()))
        l_entity_set.add(new Accessor(lookupPriority: 0, platform: "Any", appVersion: "Any", user: "Any", FIID: "Any", product: "Any", productGroup: "Multi Currency", accessorName: "Any accessor Multi Currency 0.0.x", appName: "Any", endpoint: GC_ANY_ENDPOINT, apiVersion: p_version_repository.findByVersionName("0.0.x").first()))
        l_entity_set.add(new Accessor(lookupPriority: 0, platform: "Any", appVersion: "Any", user: "Any", FIID: "Any", product: "Any", productGroup: "Single Currency", accessorName: "Any accessor Single Currency 1.0.x", appName: "Any", endpoint: GC_ANY_ENDPOINT, apiVersion: p_version_repository.findByVersionName("1.0.x").first()))
        l_entity_set.add(new Accessor(lookupPriority: 0, platform: "Any", appVersion: "Any", user: "Any", FIID: "Any", product: "Any", productGroup: "Multi Currency", accessorName: "Any accessor Multi Currency 1.0.x", appName: "Any", endpoint: GC_ANY_ENDPOINT, apiVersion: p_version_repository.findByVersionName("1.0.x").first()))
        l_entity_set.add(new Accessor(lookupPriority: 0, platform: "Any", appVersion: "Any", user: "Any", FIID: "Any", product: "Any", productGroup: "Single Currency", accessorName: "Any accessor Single Currency 2.0.x", appName: "Any", endpoint: GC_ANY_ENDPOINT, apiVersion: p_version_repository.findByVersionName("2.0.x").first()))
        l_entity_set.add(new Accessor(lookupPriority: 0, platform: "Any", appVersion: "Any", user: "Any", FIID: "Any", product: "Any", productGroup: "Multi Currency", accessorName: "Any accessor Multi Currency 2.0.x", appName: "Any", endpoint: GC_ANY_ENDPOINT, apiVersion: p_version_repository.findByVersionName("2.0.x").first()))
        ...
        l_entity_set.add(new Accessor(lookupPriority: 1, platform: "Any", appVersion: "Any", user: "Any", FIID: "1100", product: "Any", accessorName: "", appName: "Whitelabeled Single Currency (Sandbox)", endpoint: p_endpoint_repository.findByEndpointName("Sandbox").first(), apiVersion: p_version_repository.findByVersionName("0.0.x").first()))
